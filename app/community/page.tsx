              ...
              <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1">
                  <div 
                    ...
                    onClick={() => setSelectedImage("/certificate.jpeg")}
                  >
                    <img
                      src="/certificate.jpeg"
                      alt="Certificate"
                ...
                <div className="md:col-span-2 flex flex-col justify-center">
                 ...
                 •  Volunteered as a scribe to assist students with learning disorders during Central Board of Secondary
                    Education Examinations | <b>2023,2025</b><br />
                    • Participated in a crowdfunding campaign to provide reusable sanitary pads for underprivileged girls and
                    women in Haryana, <b>raising ₹15,600</b> |<b> 2024</b><br/>
                    • As Youth President of Vaish World Foundation, inspired and mobilized peers to engage in social service
                    initiatives. |<b> 2025</b><br/>
