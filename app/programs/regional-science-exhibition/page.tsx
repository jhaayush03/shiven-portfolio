              ...
              <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1">
                  <div 
                    ...
                    onClick={() => setSelectedImage("/rgc1.png")}
                  >
                    <img
                      src="/rgc1.png"
                      alt="Certificate"
                ...
                <div className="md:col-span-2 flex flex-col justify-center">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-6 text-sm sm:text-base group-hover:text-gray-200 transition-colors duration-500">
                    Represented school at CBSE Regional Science Exhibition and presented a
design for a environmental friendly firecracker show building which can be used to avoid pollution during Diwali
Festival.
                  </p>
