...
export default function Portfolio() {
  ...
  const images = [
    {
      id: 1,
      placeholder: "Harvard YLC",
      src: "/i1.jpg",
    },
    {
      id: 2,
      placeholder: "Mentored by Harvard Students",
      src: "/i2.jpg",
    },
    {
      id: 3,
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1">
                  <div 
                    ...
                    onClick={() => setSelectedImage("/image144.jpeg")}
                  >
                    <img
                      src="/image144.jpeg"
                      alt="Certificate"
                ...
                <div className="md:col-span-2 flex flex-col justify-center">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-6 text-sm sm:text-base group-hover:text-gray-200 transition-colors duration-500">
                    Selected to participate in the Harvard Youth Lead the Change program, developing a
project to combat fast fashion by repurposing excess cloth into eco-friendly cotton bags. Individually recognised with an
Honourable Mention for outstanding performance, while the team received an Oral Mention for delivering the Best
