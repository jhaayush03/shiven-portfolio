...
export default function Portfolio() {
  ...
  const images = [
    {
      id: 1,
      placeholder: "Picture with Mentors",
      src: "/ylac1.png",
    },
    {
      id: 2,
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1">
                  <div 
                    ...
                    onClick={() => setSelectedImage("/image135.jpeg")}
                  >
                    <img
                      src="/image135.jpeg"
                      alt="Certificate"
                ...
                <div className="md:col-span-2 flex flex-col justify-center">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-6 text-sm sm:text-base group-hover:text-gray-200 transition-colors duration-500">
                    Selected to participate in the YLAC High School Achievers
                    Program — a competitive initiative focused on social impact,
                    leadership, and problem-solving. The program nurtured a
                    deeper understanding of civic responsibility, empathy, and
