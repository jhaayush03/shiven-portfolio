              ...
              <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1">
                  <div 
                    ...
                    onClick={() => setSelectedImage("/image180.jpeg")}
                  >
                    <img
                      src="/image180.jpeg"
                      alt="Certificate"
                ...
                <div className="md:col-span-2 flex flex-col justify-center">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-6 text-sm sm:text-base group-hover:text-gray-200 transition-colors duration-500">
                        • <b>HSBC Global Banking & Markets Simulation – Oct 2024: </b> Completed a simulation on M&A strategy, DCM analysis, and
                        matching financial products with client needs.<br/>
                        • <b>JPMorgan Chase Investment Banking Simulation – Dec 2024:</b> Identified M&A targets, built DCF valuation models, and
                        prepared client summaries for strategic decisions.<br/>
                        • <b>KPMG U.S. Audit Simulation – Mar 2025:</b> Conducted audit planning, evaluated confirmations, reviewed OTC processes,
                        and communicated findings via a video presentation.<br/>
                        • <b>BCG Strategy Consulting Simulation – Mar 2025:</b> Advised a telco company on declining profits, conducted market
                        research, built Excel models, and presented actionable recommendations to stakeholders
                  </p>
