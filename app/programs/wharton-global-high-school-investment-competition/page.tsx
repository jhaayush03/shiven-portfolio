              ...
              <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1">
                  <div 
                    ...
                    onClick={() => setSelectedImage("/image178.jpeg")}
                  >
                    <img
                      src="/image178.jpeg"
                      alt="Certificate"
                ...
                <div className="md:col-span-2 flex flex-col justify-center">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-6 text-sm sm:text-base group-hover:text-gray-200 transition-colors duration-500">
                    University of Pennsylvania : As the team
leader, analysed global financial markets, developed investment strategies, and managed simulated portfolios. Gained
hands-on experience in financial decision-making and risk assessment 
                  </p>
