          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                Music has always been the background score to my life, but Tabla
                is where it gets personal.
              </p>

              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                I started learning when I was much younger, back when I couldn’t
                pronounce “teentaal” properly. Over time, it became my favorite
                way to get lost. Tabla is mathematical and messy at the same
                time. It's a rhythm that doesn’t need words. When the beats line
                up, it’s like everything else shuts up for a second.
              </p>
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                I’ve spent years tapping out bols on random surfaces, desks,
                water bottles, friends’ shoulders (they’ve stopped flinching at
                this point). What I love is how Tabla has its own language, a
                grammar of sound that’s both ancient and alive.
              </p>
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                Outside of playing, I live with music. It’s always playing
                somewhere, Nas, Jay-Z, or jazz bleeding into whatever I’m doing.
                Some people write journals; I replay the same four songs on loop
                until life makes sense again. Tabla gives me rhythm. Music gives
                it a shape. Together, they’re my favorite kind of noise.
              </p>
            </div>
          </div>
        </div>
