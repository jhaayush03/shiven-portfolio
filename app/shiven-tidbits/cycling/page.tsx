          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                Cycling is my way of escaping without actually going anywhere. I
                picked it up in Dubai, mostly to commute. But somewhere between
                Jaipur’s cracked roads and early morning rides through Aravalis,
                it became my thing. There’s nothing like bombing down a hill at
                slightly irresponsible speeds with music in your ears and your
                brain somewhere else entirely.
              </p>

              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                I love how cycling’s not about winning for me, in that way I
                don’t consider it a sport. It’s about that weird quiet when it’s
                just me, my legs, and a road. It’s freedom, but with more lactic
                acid. My best rides are the ones where I come back covered in
                dust, sunburned, and oddly happy.
              </p>
            </div>
          </div>
        </div>
