          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                Reading has always been my quiet form of training. The kind that
                builds invisible wiring in your head. I don’t read to collect
                quotes or sound smart. I read because ideas, when they land
                right, don’t stay in the margins.
              </p>

              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                Free Will made me interrogate why I make decisions, which now
                shows up every time I slow down a BizForHer strategy call and
                ask “are we choosing this or reacting to it?” Mastery made me
                fall in love with the grind itself, the unglamorous part of
                building my ventures, when it’s just me, a whiteboard, and
                twenty bad ideas before one good one lands. The Intelligent
                Investor taught me to zoom out. That instinct now guides how I
                build projects with time horizons that make sense in years, not
                weeks.
              </p>
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                Books like Meditations shape how I talk to people. They remind
                me that everything, inequality, markets, ambition, failure, sits
                in a longer human story. No Limits by Michael Phelps changed how
                I approach powerlifting, investing, and basically anything that
                requires stubborn repetition.
              </p>
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                Every venture I’ve built has fingerprints of what I’ve read.
                Dwaar’s entire structure grew out of my obsession with how
                systems shape people’s choices. BizForHer’s voice is fueled by
                every idea I’ve ever stolen from someone smarter than me. I
                don’t separate reading from living. I use what I read, sometimes
                intentionally, often accidentally, in everything I build, say,
                or even how I wait for things to play out.
              </p>
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                The books are the foundation. The execution is just me, building
                on it.
              </p>
            </div>
          </div>
