          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                When I joined Compounding Gems India Aravalli Fund I as an
                associate, I wanted to pull apart businesses until their logic
                made sense. And so I spent hours digging through industries that
                don’t usually get flashy coverage, and trying to decode why they
                were misunderstood by the market. Often, that meant stepping
                beyond the numbers: talking to management, reading footnotes no
                one cared about, and questioning assumptions others took for
                granted.
              </p>

              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                What fascinated me most was connecting seemingly unrelated dots,
                pulling threads between philosophy, market psychology, and
                valuation. That curiosity often led to lively debates within the
                team, where I had to defend my theses in front of seasoned
                investors. I was questioning the framework of giants.
              </p>

              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                One of my proudest (and frankly most fun) moments came when I
                walked into a listed company’s office to resolve inconsistencies
                I’d spotted between their projections and actual output, because
                I needed an answer.
              </p>
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                Through my internship, my valuation models got sharper, but more
                importantly, so did my temperament. I learned that real
                investing is about patience, intellectual honesty, and having
                the courage to question even your own conclusions. My work at
                Compounding Gems continues to shape how I think.
              </p>
            </div>
          </div>
        </div>
