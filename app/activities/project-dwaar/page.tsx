          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                One day, I casually asked my driver if he’d ever invested in a
                micro-SIP. He looked at me blankly and said, “What’s that?” So I
                explained how small, automated mutual fund investments could
                help him build wealth over time.
              </p>

              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                The next day, he came back confused about how to even sign up.
                That moment stuck with me. Here was someone who worked hard
                every day, but simply didn’t have access to the tools that build
                wealth for others. Simply because no one had ever shown him how.
              </p>
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                That’s how Project Dwaar was born, in collaboration with HDFC
                AMC, India’s largest asset management company, with one goal: to
                make wealth creation accessible to the people who’ve always been
                left out of the conversation.
              </p>

              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                Today, our team of 20+ works across 8 cities, helping more than
                9,800 low-income families and athletes start their SIP journeys.
                After every financial literacy session, we don’t just say “good
                luck” and leave, we stand there, one by one, helping each person
                register for their mutual fund scheme. Every form filled, every
                account opened, is someone taking their first step towards
                financial security.
              </p>
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                It’s slow work. Patient work. But it’s also real, tangible
                change. Because mutual funds are a chance to rewrite someone’s
                financial story.
              </p>
            </div>
          </div>
