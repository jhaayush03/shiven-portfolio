          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                I was named one of just two winners out of 10,000+ students for
                the Youth Excellence in Economics Award by OneYoungIndia,
                recognition that grew out of a slightly obsessive streak with
                markets, deep-value investing, and research. Between publishing
                my book and building Invesh, I’d spent months trying to make
                investing more understandable for young people. Getting
                recognized for something that started with late-night
                spreadsheets by a massive educational conglomerate in India felt
                surreal.
              </p>
            </div>
          </div>
