          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                Best Delegate at Oxford MUN, Third Place at Harvard MUN, and a
                bunch of other wins that involved way too much caffeine and
                diplomacy that was anything but diplomatic.
              </p>

              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                I loved the theatre of it, the chaos of unmods, the alliances in
                hallways, the weirdly intense arguments over clauses that
                probably won’t change the world but sure feel like they will.
              </p>

              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                But it wasn’t just about winning. Over time, I found myself on
                the other side of the table, serving on secretariats for CISMUN,
                OXMUN, and JPISMUN, shaping the debates, not just jumping into
                them. It’s a different kind of power when you’re the one
                deciding which crises explode and which resolutions survive.
              </p>
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                MUNs taught me how to argue without shouting, lead without
                titles, and occasionally charm my way out of very bad policy
                positions.
              </p>
            </div>
          </div>
